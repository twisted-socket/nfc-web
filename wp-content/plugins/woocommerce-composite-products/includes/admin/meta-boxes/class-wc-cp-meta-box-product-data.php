...
class WC_CP_Meta_Box_Product_Data {
	...
	public static function edit_in_cart_option() {
		...
		woocommerce_wp_checkbox( array(
			...
			'label'       => __( 'Editing in cart', 'woocommerce-composite-products' ),
			'value'       => $composite_product_object->get_editable_in_cart( 'edit' ) ? 'yes' : 'no',
			'description' => __( 'Allow modifications to the configuration of this Composite after it has been added to the cart.', 'woocommerce-composite-products' ),
			'desc_tip'    => true
		) );
		...
		?><div class="options_group bundle_group bto_clearfix">
			...
			<div class="bto_layouts bto_clearfix form-field">
				<label class="bundle_group_label">
					<?php _e( 'Layout', 'woocommerce-composite-products' ); echo wc_help_tip( __( 'Choose a layout for this Composite product.', 'woocommerce-composite-products' ) ); ?>
				</label>
	...
	public static function scenario_action_compat_group( $id, $scenario_data, $composite_data, $product_id ) {
		...
		<div class="scenario_action_compat_group" >
			<div class="form-field">
				...
				<?php echo wc_help_tip( __( 'Creates a group of dependent selections from the products/variations included in this Scenario. Any selections that do not belong in this group will be disabled unless they are included in another dependency group.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function scenario_action_hide_components( $id, $scenario_data, $composite_data, $product_id ) {
		...
		<div class="scenario_action_conditional_components_group" >
			<div class="form-field toggle_conditional_components">
				...
				<?php echo wc_help_tip( __( 'Hide one or more Components when this Scenario is active. Note that any Components added in this field will be hidden by default until the conditions for hiding or showing them can be evaluated.', 'woocommerce-composite-products' ) ); ?>
			</div>
							...
							if ( false === $use_ajax ) {
								...
								foreach ( $component_options_data as $option_id => $option_data ) {
									...
									if ( $product_type === 'variable' ) {
										$product_title          = WC_CP_Helpers::get_product_title( $option_data, sprintf( _x( '%s &ndash; Any Variation', 'any product variation', 'woocommerce-composite-products' ), $title ) );
									...
									foreach ( $scenario_data[ 'component_data' ][ $component_id ] as $product_id_in_scenario ) {
										...
										if ( $product_id_in_scenario == -1 ) {
											...
											if ( $product_in_scenario->get_type() === 'variation' ) {
												...
												$selections_in_scenario[ $product_id_in_scenario ] = sprintf( _x( '%s &ndash; Any Variation', 'any product variation', 'woocommerce-composite-products' ), WC_CP_Helpers::get_product_title( $product_in_scenario ) );
											} else {
		...
		<div class="component_selection_details">
			<div class="form-field">
				...
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Title', 'woocommerce-composite-products' ); ?>
					<?php echo wc_help_tip( __( 'Check this option to hide the selected Component Option title.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Description', 'woocommerce-composite-products' ); ?>
					<?php echo wc_help_tip( __( 'Check this option to hide the selected Component Option description.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Thumbnail', 'woocommerce-composite-products' ); ?>
					<?php echo wc_help_tip( __( 'Check this option to hide the selected Component Option thumbnail.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_selection_details_option">
					...
					<span class="labelspan"><?php echo __( 'Hide Price', 'woocommerce-composite-products' ); ?>
					<?php echo wc_help_tip( __( 'Check this option to hide the selected Component Option price.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<?php
		...
		<div class="component_subtotal_visibility">
			<div class="form-field">
				...
				<div class="component_subtotal_visibility_option">
					...
					<?php echo wc_help_tip( __( 'Controls the visibility of the Component price/subtotal in cart/checkout templates.', 'woocommerce-composite-products' ) ); ?>
				</div>
				<div class="component_subtotal_visibility_option">
					...
					<?php echo wc_help_tip( __( 'Controls the visibility of the Component price/subtotal in order details &amp; e-mail templates.', 'woocommerce-composite-products' ) ); ?>
				</div>
			</div>
		</div>
		<?php
	...
	public static function component_config_options( $id, $data, $product_id ) {
		...
		<div class="component_query_type bto_query_type">
			<div class="form-field">
				...
				?></select>
				<?php echo wc_help_tip( __( 'Every Component includes an assortment of products to choose from - the <strong>Component Options</strong>. You can add products individually, or select a category to add all associated products.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		...
		<div class="component_selector bto_selector bto_query_type_selector bto_multiselect bto_query_type_product_ids">
			<div class="form-field"><?php
				...
				?><select id="bto_ids_<?php echo $id; ?>" name="bto_data[<?php echo $id; ?>][assigned_ids][]" class="wc-product-search" multiple="multiple" style="width: 75%;" data-limit="500" data-action="woocommerce_json_search_products" data-placeholder="<?php echo  __( 'Search for a product&hellip;', 'woocommerce' ); ?>" data-sortable="true"><?php
		...
		?><div class="component_default_selector default_selector">
			<div class="form-field">
				...
				if ( ! empty( $component_options ) ) {
					...
					echo wc_help_tip( __( 'Select a product to use as the default, pre-selected Component Option.', 'woocommerce-composite-products' ) );

				} else {
					?><div class="prompt"><em><?php _e( 'To choose a Default Option, add some products in <strong>Basic Settings > Component Options</strong> and click <strong>Save Configuration</strong>&hellip;', 'woocommerce-composite-products' ); ?></em></div><?php
				}
	...
	public static function component_config_shipped_individually( $id, $data, $product_id ) {
		...
		<div class="group_shipped_individually">
			<div class="form-field">
				...
				<?php echo wc_help_tip( __( 'Check this option if this Component is shipped separately from the Composite.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_priced_individually( $id, $data, $product_id ) {
		...
		<div class="group_priced_individually">
			<div class="form-field">
				...
				<?php echo wc_help_tip( __( 'Check this option to have the price of this Component added to the base price of the Composite.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_discount( $id, $data, $product_id ) {
		...
		<div class="group_discount">
			<div class="form-field">
				...
				<?php echo wc_help_tip( __( 'Component-level discount applied to any selected Component Option when <strong>Priced Individually</strong> is checked.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function component_config_optional( $id, $data, $product_id ) {
		...
		<div class="group_optional" >
			<div class="form-field">
				...
				<?php echo wc_help_tip( __( 'Checking this option will allow customers to proceed without making any selection for this Component at all.', 'woocommerce-composite-products' ) ); ?>
			</div>
		</div>
		<?php
	}
	...
	public static function composite_pricing_options() {
		...
		// Hide Shop Price.
		woocommerce_wp_checkbox( array(
			'id'            => '_bto_hide_shop_price',
			'wrapper_class' => 'composite_pricing show_if_composite',
			'label'         => __( 'Hide Price', 'woocommerce-composite-products' ),
			'value'         => $composite_product_object->get_hide_shop_price( 'edit' ) ? 'yes' : 'no',
			'description'   => __( 'Disable all internal price calculations and hide the Composite price displayed in the shop catalog and product summary.', 'woocommerce-composite-products' ),
			'desc_tip'      => true
		) );
	}
	...
	public static function process_posted_composite_configuration( $composite_id, $posted_composite_data = array() ) {
		...
		if ( isset( $posted_composite_data[ 'bto_style' ] ) ) {
			$props[ 'layout' ] = stripslashes( $posted_composite_data[ 'bto_style' ] );
		}
