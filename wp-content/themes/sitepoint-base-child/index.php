...
<?php include get_stylesheet_directory() . '/lib/html_head.php'; ?>

<body>
<?php include get_stylesheet_directory(). '/lib/header.php'; ?>
...
<div class="fadein" style="">
	...
	<?php include get_stylesheet_directory() . '/lib/footer.php'; ?>
</div>

<?php include get_stylesheet_directory() . '/lib/footer_scripts.php'; ?>
</body>
</html>