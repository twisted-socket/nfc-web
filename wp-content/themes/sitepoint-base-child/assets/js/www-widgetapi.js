(function ()
{
	...
	var t = "closure_uid_" + (1E9 * Math.random() >>> 0), ca = 0;
	...
	;
	var wa = C("Opera"), D = C("Trident") || C("MSIE"), xa = C("Edge"), E = C("Gecko") && !(-1 != B.toLowerCase().indexOf("webkit") && !C(
			"Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"), ya = -1 != B.toLowerCase().indexOf("webkit") && !C("Edge");
	...
	function Fa(a)
	{
		ua(a, function ()
		{
			for (var b = 0, c = ga(String(Ea)).split("."), d = ga(String(a)).split("."), e = Math.max(c.length,
				...
				do {
					...
					b = x(0 == h[1].length ? 0 : parseInt(h[1], 10), 0 == m[1].length ? 0 : parseInt(m[1], 10)) || x(0 == h[2].length,
							0 == m[2].length) || x(h[2], m[2]);
					h = h[3];
					m = m[3]
				} while (0 == b)
			}
	...
	var Ga;
	var Ha = k.document;
	Ga = Ha && D ? za() || ("CSS1Compat" == Ha.compatMode ? parseInt(Ea, 10) : 5) : void 0;
	var Ia;
	if (!(Ia = !E && !D)) {
		var Ja;
		if (Ja = D) {
	...
	function Qa()
	{
			...
			"Presto") && (a = function ()
		{
			...
			a.write("");
			a.close();
			var c = "callImmediate" + Math.random(), d = "file:" == b.location.protocol ? "*" : b.location.protocol + "//" + b.location.host, a = u(
				function (a)
				{
		...
		if (-1 != String(a).indexOf("[native code]")) {
			...
			F = function ()
			{
				...
				"function" != p(k.setImmediate) || k.Window && k.Window.prototype && !C(
					"Edge") && k.Window.prototype.setImmediate == k.setImmediate ? (Pa || (Pa = Qa()), Pa(a)) : k.setImmediate(a)
			}
		}
	}
	...
	g.clear = function (a)
	{
		if (a) {
			var b = this.b[a];
			b && (y(b, this.F, this), delete this.b[a])
		} else {
	...
	var fb = window.yt && window.yt.msgs_ || l("window.ytcfg.msgs") || {};
	v("yt.msgs_", fb);
	function gb(a)
	{
		var b = arguments;
	...
	function jb(a, b)
	{
		var c = l("yt.logging.errors.log");
		c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in J ? J.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), gb(
			"ERRORS", c))
	}
	;
	var kb = l("yt.dom.getNextId_");
	if (!kb) {
		kb = function ()
		{
			return ++lb
	...
	var A = l("yt.events.listeners_") || {};
	v("yt.events.listeners_", A);
	var nb = l("yt.events.counter_") || {count: 0};
	...
	function pb(a, b, c)
	{
		if (a && (a.addEventListener || a.attachEvent)) {
			var d = ob(a, b, c);
			if (!d) {
				var d = ++nb.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document), f;
				f = e ? function (d)
				{
					d = new K(d);
					if (!La(d.relatedTarget, function (b)
						{
							return b == a
						})) {
				...
				f = ib(f);
				a.addEventListener ? ("mouseenter" == b && e ? b = "mouseover" : "mouseleave" == b && e ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), a.addEventListener(
					b, f, !1)) : a.attachEvent("on" + b, f);
				A[d] = [a, b, c, f, !1]
			}
		}
	}
	...
	function qb(a)
	{
		...
		{
			if (a in A) {
				var b = A[a], d = b[0], e = b[1], f = b[3], b = b[4];
	...
	function wb(a)
	{
		...
		a = "yt-" + a;
		var c = document;
		a = z(c.querySelectorAll && c.querySelector ? c.querySelectorAll("." + a) : Ka(a));
		return qa(b, a)
	}

	function M(a, b)
	{
		return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[sb(b)] : a.getAttribute(
			"data-" + b) : null
	}
	...
	function N(a, b, c)
	{
		...
		if (a = r(a) ? b.getElementById(a) : a) {
			if ("iframe" != a.tagName.toLowerCase() && (b = yb(this,
					a), this.h = a, (c = a.parentNode) && c.replaceChild(b,
					a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[t] || (b[t] = ++ca), a.id = "widget" + b), L[this.a.id] = this, window.postMessage) {
				this.f = new H;
				zb(this);
				a = O(this.b, "events");
				for (var d in a) {
	...
	g.l = function (a, b)
	{
		this.f.c || (b = {target: this, data: b}, this.f.I(a, b), xb(this.s + "." + a, b))
	};
	function yb(a, b)
	{
		...
		(b = O(a.b, "width")) && c.setAttribute("width", b);
		(b = O(a.b, "height")) && c.setAttribute("height", b);
		var h = a.u();
	...
	function Bb(a, b)
	{
		a.v[b] || (a.v[b] = !0, Q(a, "addEventListener", [b]))
	}
	...
	var R = "StopIteration" in k ? k.StopIteration : {message: "StopIteration", stack: ""};
	...
	function Cb(a, b, c)
	{
		P || (P = {}, pb(window, "message", u(a.g, a)));
		P[c] = b
	}

	W.prototype.g = function (a)
	{
		if (a.origin == O(this, "host") || a.origin == O(this, "host").replace(/^http:/, "https:")) {
			var b;
			try {
				b = Ma(a.data)
			} catch (c) {
			...
			if (a = P[b.id]) {
				a.B = !0, a.B && (y(a.w, a.C, a), a.w.length = 0), a.J(b)
			}
		}
	};
	function Lb(a)
	...
	g.V = function ()
	{
		var a = O(this.b, "host") + this.o(), b = '<iframe width="' + parseInt(O(this.b, "width"), 10) + '" height="' + parseInt(
				O(this.b, "height"), 10) + '" src="';
		na.test(a) && (-1 != a.indexOf("&") && (a = a.replace(ha, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(ia,
			"&lt;")), -1 != a.indexOf(">") && (a = a.replace(ja, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(ka,
			"&quot;")), -1 != a.indexOf("'") && (a = a.replace(la, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(ma, "&#0;")));
	...
	g.K = function (a)
	{
		Q(this, "setVideoDescription", arguments)
	};
	g.M = function (a)
	{
		Q(this, "setVideoKeywords", arguments)
	};
	g.N = function (a)
	{
		Q(this, "setVideoPrivacy", arguments)
	};
	g.L = function (a)
	{
		Q(this, "setVideoDraftPrivacy", arguments)
	};
	g.O = function (a)
	{
		Q(this, "setVideoTitle", arguments)
	};
